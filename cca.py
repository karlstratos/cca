...
def main(args):
    ...
    if args.views:        
        ...
        C.get_stats()        
        C.set_params(args.cca_dim, args.kappa, args.extra_dim, args.power_num, args.no_centering, args.subspace_iter)        
        C.start_logging()        
        C.approx_cca()
        C.write_result()
        C.end_logging()
...
if __name__=='__main__':    
    ...
    argparser.add_argument('--subspace_iter', action='store_true',                help='replace power iteration with subspace iteration')
    #_________________________________________________________________________________________________________________________________
